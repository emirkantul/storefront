    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_category', models.CharField(choices=[('Cold Drink', 'Cold Drink'), ('Hot Drink', 'Hot Drink'), ('Alcohol', 'Alcohol'), ('Starter', 'Starter'), ('Meat&Fish', 'Meat&Fish'), ('Soup', 'Soup'), ('Burger', 'Burger'), ('Pizza', 'Pizza'), ('Pasta', 'Pasta'), ('Desert', 'Desert')], max_length=100, null=True)),
